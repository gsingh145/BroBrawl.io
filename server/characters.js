...
const CLASSES = {
  zoner: {
    moveSpeed: 4, jumpVelocity: -10, weight: 1, dmgDealtMult: 0.9, dmgTakenMult: 1, stocks: 3, jumpCount: 2,
    attacks: {
  ...
  heavy: {
    moveSpeed: 3, jumpVelocity: -9, weight: 0.6, dmgDealtMult: 1.4, dmgTakenMult: 0.8, stocks: 4, jumpCount: 1,
    attacks: {
      neutral: ATK({ active: 2, cd: 10, dmg: 10, kb: 12, w: 26, h: 24 }),
  ...
  combo: {
    moveSpeed: 5, jumpVelocity: -11, weight: 0.85, dmgDealtMult: 0.85, dmgTakenMult: 1.05, stocks: 3, jumpCount: 2,
    attacks: {
      neutral: ATK({ active: 2, cd: 4, dmg: 2, kb: 3, w: 18, h: 16 }),
      side: ATK({ active: 3, cd: 5, dmg: 3, kb: 5, w: 30, h: 20 }),
