...
const BASE_STATE = {
    ...
    attackTimer: 0, attackStartup: 0, attackActiveTimer: 0,
    specialAttackTimer: 0, specialAttackStartup: 0, specialAttackActiveTimer: 0,
...
function copyState(player) {
    return {
        ...
        attackStartup: player.attackStartup,
        attackActiveTimer: player.attackActiveTimer,
        specialAttacking: player.specialAttacking,
        specialAttackStartup: player.specialAttackStartup,
        specialAttackActiveTimer: player.specialAttackActiveTimer,
