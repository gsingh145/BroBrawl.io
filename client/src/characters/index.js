...
export const CHARACTERS = {
  ...
  the_damned: {
    ...
    attacks: {
      ...
      side:    ATK({ startup: 4, active: 5, cd: 10, dmg: 0,  kb: 0,  w: 20, h: 20, spawnsProjectile: true }),
    ...
    specials: {
      ...
      side:    ATK({ startup: 4, active: 7, cd: 14, dmg: 0,  kb: 0,  w: 24, h: 24, spawnsProjectile: true }),
